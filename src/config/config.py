...
MAX_NODES: int = 1_000_000  # example cap

# Topic configuration
TOPIC_REFRESH_EVERY: int = 100
TOPIC_REFRESH_SECS: int = 600  # 10 minutes
...
TWITTER_SIM_EVENTS_PER_BATCH: int = 4
TWITTER_SIM_BATCH_INTERVAL: int = 120  # seconds
TRENDS_CATEGORY: str = "all"
TRENDS_COUNT: int = 8
TRENDS_INTERVAL_SEC: int = 1800  # 30 minutes
REGIONS: tuple[str, ...] = ("US", "SG",) # Currently, collectors only use first region as default

# Training configuration
TRAINING_INTERVAL_HOURS: int = 168  # 7 days
MIN_EVENTS_FOR_TRAINING: int = 100
SCHEDULER_POLL_SECONDS: int = 3600  # 1 hour
TRAIN_EPOCHS: int = 8

# Preprocessing configuration
PERIODIC_REBUILD_SECS: int = 604800  # 1 week
